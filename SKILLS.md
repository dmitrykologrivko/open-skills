...
| `error-investigation` | Investigate crashes from a stack trace or an error-monitoring MCP reference; report evidence, root cause, impact, counts, and fix priority without changing code. | [`.agents/skills/error-investigation/SKILL.md`](.agents/skills/error-investigation/SKILL.md) |
