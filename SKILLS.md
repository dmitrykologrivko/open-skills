...
| `error-investigation` | Investigate crashes from a stack trace or an error-monitoring MCP reference; use diagnostic red/green tests and report evidence, root cause, impact, counts, and fix priority without applying production fixes. | [`.agents/skills/error-investigation/SKILL.md`](.agents/skills/error-investigation/SKILL.md) |
